...
/// 💡 Советы по улучшению бизнеса (fallback)
pub fn business_insights_response(_context: Option<&str>) -> String {
    "💡 **Советы по улучшению бизнеса**\n\n\
     Укажите название бизнеса для получения персональных рекомендаций.\n\n\
     📌 Примеры запросов:\n\
     • `советы для Tech Startup`\n\
     • `как улучшить Fodi Sushi`\n\
     • `рекомендации по бизнесу Coffee Shop`\n\n\
